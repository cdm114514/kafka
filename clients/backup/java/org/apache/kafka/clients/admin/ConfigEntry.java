...
public class ConfigEntry
{
    ...
    {
        this(name, value, isDefault ? ConfigSource.DEFAULT_CONFIG : ConfigSource.UNKNOWN, isSensitive, isReadOnly, Collections.<ConfigSynonym>emptyList(), ConfigType.UNKNOWN, null);
    }
     ...
     */
    ConfigEntry(String name, String value, ConfigSource source, boolean isSensitive, boolean isReadOnly, List<ConfigSynonym> synonyms, ConfigType type, String documentation)
    {
    ...
    public static class ConfigSynonym
    {
        ...
        public String toString()
        {
            return "ConfigSynonym(" + "name=" + name + ", value=" + value + ", source=" + source + ")";
        }
    }
}
