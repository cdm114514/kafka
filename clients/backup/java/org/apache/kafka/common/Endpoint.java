...
public class Endpoint
{
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(this.listenerName, that.listenerName) && Objects.equals(this.securityProtocol, that.securityProtocol) && Objects.equals(this.host, that.host) && this.port == that.port;
    ...
    {
        return "Endpoint(" + "listenerName='" + listenerName + '\'' + ", securityProtocol=" + securityProtocol + ", host='" + host + '\'' + ", port=" + port + ')';
    }
}
