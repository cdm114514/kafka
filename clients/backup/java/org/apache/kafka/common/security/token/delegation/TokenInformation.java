...
public class TokenInformation
{
    ...
    {
        return "TokenInformation{" + "owner=" + owner + ", renewers=" + renewers + ", issueTimestamp=" + issueTimestamp + ", maxTimestamp=" + maxTimestamp + ", expiryTimestamp=" + expiryTimestamp + ", tokenId='" + tokenId + '\'' + '}';
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return issueTimestamp == that.issueTimestamp && maxTimestamp == that.maxTimestamp && Objects.equals(owner, that.owner) && Objects.equals(renewers, that.renewers) && Objects.equals(tokenId, that.tokenId);
    }
