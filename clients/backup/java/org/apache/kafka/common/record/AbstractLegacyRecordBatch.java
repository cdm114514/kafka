...
public abstract class AbstractLegacyRecordBatch extends AbstractRecordBatch implements Record
{
    ...
    private static class DeepRecordsIterator extends AbstractIterator<Record> implements CloseableIterator<Record>
    {
        ...
        private DeepRecordsIterator(AbstractLegacyRecordBatch wrapperEntry, boolean ensureMatchingMagic, int maxMessageSize, BufferSupplier bufferSupplier)
        {
            ...
            {
                throw new InvalidRecordException("Found invalid compressed record set with null value (magic = " + wrapperMagic + ")");
            }
            ...
            try
            {
                while (true)
                {
                    ...
                    {
                        throw new InvalidRecordException("Compressed message magic " + magic + " does not match wrapper magic " + wrapperMagic);
                    }
    ...
    private static class BasicLegacyRecordBatch extends AbstractLegacyRecordBatch
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return offset == that.offset && Objects.equals(record, that.record);
        }
