...
public class FileLogInputStream implements LogInputStream<FileLogInputStream.FileChannelRecordBatch>
{
    ...
    public FileChannelRecordBatch nextBatch() throws IOException
    {
        ...
        {
            throw new CorruptRecordException(String.format("Found record size %d smaller than minimum record " + "overhead (%d) in file %s.", size, LegacyRecord.RECORD_OVERHEAD_V0, fileRecords.file()));
        }
    ...
    public abstract static class FileChannelRecordBatch extends AbstractRecordBatch
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return offset == that.offset && position == that.position && batchSize == that.batchSize && Objects.equals(channel, thatChannel);
        }
