...
public class DescribeGroupsResponse extends AbstractResponse
{
    ...
    public static DescribedGroupMember groupMember(final String memberId, final String groupInstanceId, final String clientId, final String clientHost, final byte[] assignment, final byte[] metadata)
    {
