...
public class UpdateFeaturesRequest extends AbstractRequest
{
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e)
    {
        ...
        {
            final UpdatableFeatureResult result = new UpdatableFeatureResult().setFeature(update.feature()).setErrorCode(apiError.error().code()).setErrorMessage(apiError.message());
            results.add(result);
        }
        final UpdateFeaturesResponseData responseData = new UpdateFeaturesResponseData().setThrottleTimeMs(throttleTimeMs).setResults(results);
