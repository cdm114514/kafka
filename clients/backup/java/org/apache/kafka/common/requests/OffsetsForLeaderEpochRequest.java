...
public class OffsetsForLeaderEpochRequest extends AbstractRequest
{
    ...
    private static final Field PARTITIONS_V0 = PARTITIONS.withFields(PARTITION_ID, LEADER_EPOCH);
    ...
    private static final Field PARTITIONS_V2 = PARTITIONS.withFields(PARTITION_ID, CURRENT_LEADER_EPOCH, LEADER_EPOCH);
    private static final Field TOPICS_V2 = TOPICS.withFields(TOPIC_NAME, PARTITIONS_V2);
    ...
    public static class Builder extends AbstractRequest.Builder<OffsetsForLeaderEpochRequest>
    {
        ...
        public static Builder forConsumer(Map<TopicPartition, PartitionData> epochsByPartition)
        {
            ...
            return new Builder((short) 3, ApiKeys.OFFSET_FOR_LEADER_EPOCH.latestVersion(), epochsByPartition, CONSUMER_REPLICA_ID);
        }
        ...
        public String toString()
        {
            ...
            bld.append("OffsetsForLeaderEpochRequest(").append("epochsByPartition=").append(epochsByPartition).append(")");
            return bld.toString();
        }
    }
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e)
    {
        ...
        {
            errorResponse.put(tp, new EpochEndOffset(error, EpochEndOffset.UNDEFINED_EPOCH, EpochEndOffset.UNDEFINED_EPOCH_OFFSET));
        }
    ...
    public static class PartitionData
    {
        ...
        {
            StringBuilder bld = new StringBuilder();
            bld.append("(currentLeaderEpoch=").append(currentLeaderEpoch).append(", leaderEpoch=").append(leaderEpoch).append(")");
            return bld.toString();
        }
    }
