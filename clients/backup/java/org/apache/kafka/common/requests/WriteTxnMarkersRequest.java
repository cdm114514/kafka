...
public class WriteTxnMarkersRequest extends AbstractRequest
{
    ...
    public static class TxnMarkerEntry
    {
        ...
        {
            return "TxnMarkerEntry{" + "producerId=" + producerId + ", producerEpoch=" + producerEpoch + ", coordinatorEpoch=" + coordinatorEpoch + ", result=" + result + ", partitions=" + partitions + '}';
        }
        ...
        public boolean equals(final Object o)
        {
            ...
            return producerId == that.producerId && producerEpoch == that.producerEpoch && coordinatorEpoch == that.coordinatorEpoch && result == that.result && Objects.equals(partitions, that.partitions);
        }
    ...
    public static class Builder extends AbstractRequest.Builder<WriteTxnMarkersRequest>
    {
        ...
        public Builder(final List<TxnMarkerEntry> markers)
        {
            ...
            for (TxnMarkerEntry marker : markers)
            {
                ...
                {
                    WritableTxnMarkerTopic topic = topicMap.getOrDefault(topicPartition.topic(), new WritableTxnMarkerTopic().setName(topicPartition.topic()));
                    topic.partitionIndexes().add(topicPartition.partition());
                    topicMap.put(topicPartition.topic(), topic);
                }

                dataMarkers.add(new WritableTxnMarker().setProducerId(marker.producerId).setProducerEpoch(marker.producerEpoch).setCoordinatorEpoch(marker.coordinatorEpoch).setTransactionResult(marker.transactionResult().id).setTopics(new ArrayList<>(topicMap.values())));
            }
