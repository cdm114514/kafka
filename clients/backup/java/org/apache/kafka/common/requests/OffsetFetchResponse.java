...
public class OffsetFetchResponse extends AbstractResponse
{
    ...
    public static final PartitionData UNKNOWN_PARTITION = new PartitionData(INVALID_OFFSET, Optional.empty(), NO_METADATA, Errors.UNKNOWN_TOPIC_OR_PARTITION);
    ...
    public static final class PartitionData
    {
        ...
        public boolean equals(Object other)
        {
            ...
            return this.offset == otherPartition.offset && this.leaderEpoch.equals(otherPartition.leaderEpoch) && this.metadata.equals(otherPartition.metadata) && this.error.equals(otherPartition.error);
        }
