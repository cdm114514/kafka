...
public class EpochEndOffset
{
    ...
    {
        return "EpochEndOffset{" + "error=" + error + ", leaderEpoch=" + leaderEpoch + ", endOffset=" + endOffset + '}';
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return Objects.equals(error, that.error) && Objects.equals(leaderEpoch, that.leaderEpoch) && Objects.equals(endOffset, that.endOffset);
    }
    ...
    {
        return this.endOffset == UNDEFINED_EPOCH_OFFSET || this.leaderEpoch == UNDEFINED_EPOCH;
    }
}
