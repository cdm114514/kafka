...
public class DescribeUserScramCredentialsRequest extends AbstractRequest
{
    ...
    {
        return new DescribeUserScramCredentialsRequest(ApiKeys.DESCRIBE_USER_SCRAM_CREDENTIALS.parseRequest(version, buffer), version);
    }
    ...
    public AbstractResponse getErrorResponse(int throttleTimeMs, Throwable e)
    {
        ...
        return new DescribeUserScramCredentialsResponse(new DescribeUserScramCredentialsResponseData().setErrorCode(apiError.error().code()).setErrorMessage(apiError.message()));
    }
}
