...
public class AlterConfigOp
{
    ...
    public enum OpType
    {
        ...
        private static final Map<Byte, OpType> OP_TYPES = Collections.unmodifiableMap(Arrays.stream(values()).collect(Collectors.toMap(OpType::id, Function.identity())));
    ...
    {
        return "AlterConfigOp{" + "opType=" + opType + ", configEntry=" + configEntry + '}';
    }
}
