...
public class RemoveMembersFromConsumerGroupResult
{
    ...
    RemoveMembersFromConsumerGroupResult(KafkaFuture<Map<MemberIdentity, Errors>> future, Set<MemberToRemove> memberInfos)
    {
        this.future = future;
    ...
    private boolean maybeCompleteExceptionally(Map<MemberIdentity, Errors> memberErrors, MemberIdentity member, KafkaFutureImpl<Void> result)
    {
