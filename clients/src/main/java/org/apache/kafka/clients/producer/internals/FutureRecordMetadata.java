...
public final class FutureRecordMetadata implements Future<RecordMetadata>
{
    ...
    public FutureRecordMetadata(ProduceRequestResult result, long relativeOffset, long createTimestamp, Long checksum, int serializedKeySize, int serializedValueSize, Time time)
    {
        this.result = result;
