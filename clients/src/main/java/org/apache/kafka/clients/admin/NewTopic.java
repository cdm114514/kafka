...
public class NewTopic
{
    ...
    {
        CreatableTopic creatableTopic = new CreatableTopic().setName(name).setNumPartitions(numPartitions.orElse(CreateTopicsRequest.NO_NUM_PARTITIONS)).setReplicationFactor(replicationFactor.orElse(CreateTopicsRequest.NO_REPLICATION_FACTOR));
        if (replicasAssignments != null)
        {
            for (Entry<Integer, List<Integer>> entry : replicasAssignments.entrySet())
            {
                creatableTopic.assignments().add(new CreatableReplicaAssignment().setPartitionIndex(entry.getKey()).setBrokerIds(entry.getValue()));
            }
        }
        if (configs != null)
        {
            ...
            {
                creatableTopic.configs().add(new CreateableTopicConfig().setName(entry.getKey()).setValue(entry.getValue()));
            }
        }
    ...
    public String toString()
    {
        ...
        bld.append("(name=").append(name).append(", numPartitions=").append(numPartitions.map(String::valueOf).orElse("default")).append(", replicationFactor=").append(replicationFactor.map(String::valueOf).orElse("default")).append(", replicasAssignments=").append(replicasAssignments).append(", configs=").append(configs).append(")");
        return bld.toString();
    }
    ...
    public boolean equals(final Object o)
    {
        ...
        return Objects.equals(name, that.name) && Objects.equals(numPartitions, that.numPartitions) && Objects.equals(replicationFactor, that.replicationFactor) && Objects.equals(replicasAssignments, that.replicasAssignments) && Objects.equals(configs, that.configs);
    }
