...
public class LazyDownConversionRecords implements BaseRecords
{
    ...
    public boolean equals(Object o)
    {
        if (o instanceof LazyDownConversionRecords)
        {
            ...
            return toMagic == that.toMagic && firstOffset == that.firstOffset && topicPartition.equals(that.topicPartition) && records.equals(that.records);
        }
        return false;
    }
    ...
    {
        return "LazyDownConversionRecords(size=" + sizeInBytes + ", underlying=" + records + ", toMagic=" + toMagic + ", firstOffset=" + firstOffset + ")";
    }
    ...
    private class Iterator extends AbstractIterator<ConvertedRecords<?>>
    {
        ...
        protected ConvertedRecords makeNext()
        {
            ...
            while (batchIterator.hasNext())
            {
                ...
                while (batchIterator.hasNext() && (isFirstBatch || (batchIterator.peek().sizeInBytes() + sizeSoFar) <= maximumReadSize))
                {
