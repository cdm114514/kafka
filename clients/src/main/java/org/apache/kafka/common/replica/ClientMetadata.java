...
public interface ClientMetadata
{
    ...
    class DefaultClientMetadata implements ClientMetadata
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return Objects.equals(rackId, that.rackId) && Objects.equals(clientId, that.clientId) && Objects.equals(clientAddress, that.clientAddress) && Objects.equals(principal, that.principal) && Objects.equals(listenerName, that.listenerName);
        }
        ...
        {
            return "DefaultClientMetadata{" + "rackId='" + rackId + '\'' + ", clientId='" + clientId + '\'' + ", clientAddress=" + clientAddress + ", principal=" + principal + ", listenerName='" + listenerName + '\'' + '}';
        }
    }
}
