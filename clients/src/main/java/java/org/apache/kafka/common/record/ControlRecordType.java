...
{
    ABORT((short) 0), COMMIT((short) 1), // Raft quorum related control messages.
QUORUM_REASSIGNMENT((short) 2), LEADER_CHANGE((short) 3),
    ...
    public static short parseTypeId(ByteBuffer key)
    {
        ...
        {
            throw new InvalidRecordException("Invalid value size found for end control record key. Must have " + "at least " + CURRENT_CONTROL_RECORD_KEY_SIZE + " bytes, but found only " + key.remaining());
        }
