...
public class FinalizedVersionRange
{
    ...
    FinalizedVersionRange(final short minVersionLevel, final short maxVersionLevel)
    {
        ...
        {
            throw new IllegalArgumentException(String.format("Expected minVersionLevel >= 1, maxVersionLevel >= 1 and" + " maxVersionLevel >= minVersionLevel, but received" + " minVersionLevel: %d, maxVersionLevel: %d", minVersionLevel, maxVersionLevel));
        }
