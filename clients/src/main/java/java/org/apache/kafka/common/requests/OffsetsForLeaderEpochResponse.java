...
public class OffsetsForLeaderEpochResponse extends AbstractResponse
{
    ...
    private static final Field PARTITIONS_V0 = PARTITIONS.withFields(ERROR_CODE, PARTITION_ID, END_OFFSET);
    ...
    private static final Field PARTITIONS_V1 = PARTITIONS.withFields(ERROR_CODE, PARTITION_ID, LEADER_EPOCH, END_OFFSET);
    private static final Field TOPICS_V1 = TOPICS.withFields(TOPIC_NAME, PARTITIONS_V1);
    ...
    private static final Schema OFFSET_FOR_LEADER_EPOCH_RESPONSE_V2 = new Schema(THROTTLE_TIME_MS, TOPICS_V1);
    ...
    public Map<Errors, Integer> errorCounts()
    {
        ...
        epochEndOffsetsByPartition.values().forEach(response -> updateErrorCounts(errorCounts, response.error()));
        return errorCounts;
    }
    ...
    public String toString()
    {
        ...
        bld.append("(type=OffsetsForLeaderEpochResponse, ").append(", throttleTimeMs=").append(throttleTimeMs).append(", epochEndOffsetsByPartition=").append(epochEndOffsetsByPartition).append(")");
        return bld.toString();
    }
}
