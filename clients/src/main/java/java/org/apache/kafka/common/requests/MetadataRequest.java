...
public class MetadataRequest extends AbstractRequest
{
    ...
    public static class Builder extends AbstractRequest.Builder<MetadataRequest>
    {
        ...
        {
            return data.topics().stream().map(MetadataRequestTopic::name).collect(Collectors.toList());
        }
    ...
    {
        return topics.stream().map(topic -> new MetadataRequestTopic().setName(topic)).collect(Collectors.toList());
    }
