...
public class TopicPartitionInfo
{
    ...
    {
        return "(partition=" + partition + ", leader=" + leader + ", replicas=" + Utils.join(replicas, ", ") + ", isr=" + Utils.join(isr, ", ") + ")";
    }
    ...
    public boolean equals(Object o)
    {
        ...
        return partition == that.partition && Objects.equals(leader, that.leader) && Objects.equals(replicas, that.replicas) && Objects.equals(isr, that.isr);
    }
