...
public class OffsetAndMetadata implements Serializable
{
    ...
    public boolean equals(Object o)
    {
        ...
        return offset == that.offset && Objects.equals(metadata, that.metadata) && Objects.equals(leaderEpoch, that.leaderEpoch);
    }
    ...
    {
        return "OffsetAndMetadata{" + "offset=" + offset + ", leaderEpoch=" + leaderEpoch + ", metadata='" + metadata + '\'' + '}';
    }
