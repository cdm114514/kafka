...
public class AdminMetadataManager
{
    ...
    enum State
    {
        QUIESCENT, UPDATE_REQUESTED, UPDATE_PENDING
    }
    ...
    public void clearController()
    {
        if (cluster.controller() != null)
        {
            ...
            this.cluster = new Cluster(cluster.clusterResource().clusterId(), cluster.nodes(), Collections.emptySet(), Collections.emptySet(), Collections.emptySet(), null);
        }
    }
