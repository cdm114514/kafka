...
public class RangeAssignorTest
{
    ...
    public void testOneConsumerNoTopic()
    {
        ...
        Map<String, List<TopicPartition>> assignment = assignor.assign(partitionsPerTopic, Collections.singletonMap(consumer1, new Subscription(Collections.emptyList())));
    ...
    {
        Map<String, Integer> partitionsPerTopic = new HashMap<>();
        Map<String, List<TopicPartition>> assignment = assignor.assign(partitionsPerTopic, Collections.singletonMap(consumer1, new Subscription(topics(topic1))));
        assertEquals(Collections.singleton(consumer1), assignment.keySet());
        assertTrue(assignment.get(consumer1).isEmpty());
    }
    ...
    public void testOneConsumerMultipleTopics()
    {
        ...
        Map<String, List<TopicPartition>> assignment = assignor.assign(partitionsPerTopic, Collections.singletonMap(consumer1, new Subscription(topics(topic1, topic2))));
    ...
    static Map<String, List<TopicPartition>> checkStaticAssignment(AbstractPartitionAssignor assignor, Map<String, Integer> partitionsPerTopic, Map<String, Subscription> consumers)
    {
