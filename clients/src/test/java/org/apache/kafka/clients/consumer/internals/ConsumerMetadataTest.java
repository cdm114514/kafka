...
public class ConsumerMetadataTest
{
    ...
    private void testPatternSubscription(boolean includeInternalTopics)
    {
        ...
        MetadataResponse response = MetadataResponse.prepareResponse(singletonList(node), "clusterId", node.id(), topics);
    ...
    public void testUserAssignment()
    {
        ...
        subscription.assignFromUser(Utils.mkSet(new TopicPartition("baz", 0), new TopicPartition("__consumer_offsets", 0)));
    ...
    private ConsumerMetadata newConsumerMetadata(boolean includeInternalTopics)
    {
        ...
        long expireMs = 50000;
        return new ConsumerMetadata(refreshBackoffMs, expireMs, includeInternalTopics, false, subscription, new LogContext(), new ClusterResourceListeners());
    }
