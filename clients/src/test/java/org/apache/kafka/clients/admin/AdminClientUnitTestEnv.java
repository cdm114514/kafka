...
public class AdminClientUnitTestEnv implements AutoCloseable
{
    ...
    public AdminClientUnitTestEnv(Time time, Cluster cluster, Map<String, Object> config, Map<Node, Long> unreachableNodes)
    {
        ...
        AdminMetadataManager metadataManager = new AdminMetadataManager(new LogContext(), adminClientConfig.getLong(AdminClientConfig.RETRY_BACKOFF_MS_CONFIG), adminClientConfig.getLong(AdminClientConfig.METADATA_MAX_AGE_CONFIG));
