...
public class MetadataCacheTest
{
    ...
    public void testMissingLeaderEndpoint()
    {
        ...
        MetadataCache cache = new MetadataCache("clusterId", nodesById, Collections.singleton(partitionMetadata), Collections.emptySet(), Collections.emptySet(), Collections.emptySet(), null);
