...
public class ConsumerGroupMetadataTest
{
    ...
    public void testInvalidGroupId()
    {
        ...
        assertThrows(NullPointerException.class, () -> new ConsumerGroupMetadata(null, generationId, memberId, Optional.empty()));
    }
    ...
    public void testInvalidMemberId()
    {
        ...
        assertThrows(NullPointerException.class, () -> new ConsumerGroupMetadata(groupId, generationId, null, Optional.empty()));
    }
    ...
    public void testInvalidInstanceId()
    {
        ...
        assertThrows(NullPointerException.class, () -> new ConsumerGroupMetadata(groupId, generationId, memberId, null));
    }
}
