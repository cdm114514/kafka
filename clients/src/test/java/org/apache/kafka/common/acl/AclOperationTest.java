...
public class AclOperationTest
{
    ...
    public void testIsUnknown() throws Exception
    {
        ...
        {
            assertEquals(info.operation + " was supposed to have unknown == " + info.unknown, info.unknown, info.operation.isUnknown());
        }
    }
    ...
    public void testCode() throws Exception
    {
        ...
        for (AclOperationTestInfo info : INFOS)
        {
            assertEquals(info.operation + " was supposed to have code == " + info.code, info.code, info.operation.code());
            assertEquals("AclOperation.fromCode(" + info.code + ") was supposed to be " + info.operation, info.operation, AclOperation.fromCode((byte) info.code));
        }
    ...
    public void testName() throws Exception
    {
        for (AclOperationTestInfo info : INFOS)
        {
            assertEquals("AclOperation.fromString(" + info.name + ") was supposed to be " + info.operation, info.operation, AclOperation.fromString(info.name));
        }
