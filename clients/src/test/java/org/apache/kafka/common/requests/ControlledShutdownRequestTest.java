...
public class ControlledShutdownRequestTest
{
    ...
    {
        ControlledShutdownRequest.Builder builder = new ControlledShutdownRequest.Builder(new ControlledShutdownRequestData().setBrokerId(1), (short) (CONTROLLED_SHUTDOWN.latestVersion() + 1));
    ...
    public void testGetErrorResponse()
    {
        for (short version = CONTROLLED_SHUTDOWN.oldestVersion(); version < CONTROLLED_SHUTDOWN.latestVersion(); version++)
        {
            ...
            ControlledShutdownResponse response = request.getErrorResponse(0, new ClusterAuthorizationException("Not authorized"));
