...
public class ProduceRequestTest
{
    ...
    public void testMixedTransactionalData()
    {
        ...
        final ProduceRequest.Builder builder = ProduceRequest.Builder.forMagic(RecordVersion.current().value, (short) -1, 5000, recordsByPartition, transactionalId);
    ...
    public void testMixedIdempotentData()
    {
        ...
        final ProduceRequest.Builder builder = ProduceRequest.Builder.forMagic(RecordVersion.current().value, (short) -1, 5000, recordsByPartition, null);
    ...
    private void assertThrowsInvalidRecordException(ProduceRequest.Builder builder, short version)
    {
        ...
        {
            assertTrue("Unexpected exception type " + e.getClass().getName(), InvalidRecordException.class.isAssignableFrom(e.getClass()));
        }
    }
    ...
    private ProduceRequest createNonIdempotentNonTransactionalRecords()
    {
        ...
        return ProduceRequest.Builder.forCurrentMagic((short) -1, 10, Collections.singletonMap(new TopicPartition("topic", 1), memoryRecords)).build();
    }
}
