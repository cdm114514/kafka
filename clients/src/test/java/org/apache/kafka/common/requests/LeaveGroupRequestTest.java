...
public class LeaveGroupRequestTest
{
    ...
    public void setUp()
    {
        members = Arrays.asList(new MemberIdentity().setMemberId(memberIdOne).setGroupInstanceId(instanceIdOne), new MemberIdentity().setMemberId(memberIdTwo).setGroupInstanceId(instanceIdTwo));
        builder = new LeaveGroupRequest.Builder(groupId, members);
    }
