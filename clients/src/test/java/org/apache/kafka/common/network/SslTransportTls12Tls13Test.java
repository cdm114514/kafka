...
public class SslTransportTls12Tls13Test
{
    ...
    public void testCiphersSuiteForTls12FailsForTls13() throws Exception
    {
        ...
        server = NetworkTestUtils.createEchoServer(ListenerName.forSecurityProtocol(SecurityProtocol.SSL), SecurityProtocol.SSL, new TestSecurityConfig(sslServerConfigs), null, TIME);
