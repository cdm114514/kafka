...
{
    private static final Schema FLAT_STRUCT_SCHEMA = new Schema(new Field.Int8("int8", ""), new Field.Int16("int16", ""), new Field.Int32("int32", ""), new Field.Int64("int64", ""), new Field.Bool("boolean", ""), new Field.Float64("float64", ""), new Field.Str("string", ""));

    private static final Schema ARRAY_SCHEMA = new Schema(new Field.Array("array", new ArrayOf(Type.INT8), ""));
    private static final Schema NESTED_CHILD_SCHEMA = new Schema(new Field.Int8("int8", ""));
    private static final Schema NESTED_SCHEMA = new Schema(new Field.Array("array", ARRAY_SCHEMA, ""), new Field("nested", NESTED_CHILD_SCHEMA, ""));
