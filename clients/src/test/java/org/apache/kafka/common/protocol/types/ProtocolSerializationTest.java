...
public class ProtocolSerializationTest
{
    ...
    public void testReadCompactArraySizeTooLarge()
    {
        ...
        int size = 10;
        ByteBuffer invalidBuffer = ByteBuffer.allocate(ByteUtils.sizeOfUnsignedVarint(Integer.MAX_VALUE) + size);
    ...
    public void testReadZeroCompactArraySize()
    {
        Type type = new CompactArrayOf(Type.INT8);
        int size = 10;
        ByteBuffer invalidBuffer = ByteBuffer.allocate(ByteUtils.sizeOfUnsignedVarint(0) + size);
    ...
    public void testReadWhenOptionalDataMissingAtTheEndIsTolerated()
    {
        ...
        Schema newSchema = new Schema(true, new Field("field1", Type.NULLABLE_STRING), new Field("field2", Type.NULLABLE_STRING, "", true, "default"), new Field("field3", Type.NULLABLE_STRING, "", true, null), new Field("field4", Type.NULLABLE_BYTES, "", true, ByteBuffer.allocate(0)), new Field("field5", Type.INT64, "doc", true, Long.MAX_VALUE));
        String value = "foo bar baz";
    ...
    {
        Schema oldSchema = new Schema(new Field("field1", Type.NULLABLE_STRING));
        Schema newSchema = new Schema(new Field("field1", Type.NULLABLE_STRING), new Field("field2", Type.NULLABLE_STRING, "", true, "default"));
        String value = "foo bar baz";
        Struct oldFormat = new Struct(oldSchema).set("field1", value);
        ByteBuffer buffer = ByteBuffer.allocate(oldSchema.sizeOf(oldFormat));
        oldFormat.writeTo(buffer);
    ...
    {
        Schema oldSchema = new Schema(new Field("field1", Type.NULLABLE_STRING));
        Schema newSchema = new Schema(true, new Field("field1", Type.NULLABLE_STRING), new Field("field2", Type.NULLABLE_STRING));
        String value = "foo bar baz";
        Struct oldFormat = new Struct(oldSchema).set("field1", value);
        ByteBuffer buffer = ByteBuffer.allocate(oldSchema.sizeOf(oldFormat));
        oldFormat.writeTo(buffer);
