...
public class FlattenedIteratorTest
{
    ...
    {
        List<List<String>> list = asList(asList("foo", "a", "bc"), asList("ddddd"), asList("", "bar2", "baz45"));
    ...
    {
        List<List<String>> list = asList(emptyList(), asList("boo", "b", "de"));
    ...
    {
        List<List<String>> list = asList(asList("aadwdwdw"), emptyList(), asList("ee", "aa", "dd"));
    ...
    {
        List<List<String>> list = asList(asList("ee", "dd"), asList("e"), emptyList());
