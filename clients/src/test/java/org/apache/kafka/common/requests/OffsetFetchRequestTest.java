...
public class OffsetFetchRequestTest
{
    ...
    public void setUp()
    {
        partitions = Arrays.asList(new TopicPartition(topicOne, partitionOne), new TopicPartition(topicTwo, partitionTwo));
        builder = new OffsetFetchRequest.Builder(groupId, false, partitions, false);
    }
