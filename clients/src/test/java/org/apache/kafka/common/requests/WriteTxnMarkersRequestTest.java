...
public class WriteTxnMarkersRequestTest
{
    ...
    public void testGetErrorResponse()
    {
        ...
        {
            WriteTxnMarkersRequest request = builder.build(version);
            WriteTxnMarkersResponse errorResponse = request.getErrorResponse(throttleTimeMs, Errors.UNKNOWN_PRODUCER_ID.exception());

            assertEquals(Collections.singletonMap(topicPartition, Errors.UNKNOWN_PRODUCER_ID), errorResponse.errors(producerId));
