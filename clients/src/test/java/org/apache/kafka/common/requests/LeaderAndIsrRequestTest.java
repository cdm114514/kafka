...
public class LeaderAndIsrRequestTest
{
    ...
    {
        LeaderAndIsrRequest.Builder builder = new LeaderAndIsrRequest.Builder((short) (LEADER_AND_ISR.latestVersion() + 1), 0, 0, 0, Collections.emptyList(), Collections.emptySet());
    ...
    public void testGetErrorResponse()
    {
        ...
        {
            LeaderAndIsrRequest.Builder builder = new LeaderAndIsrRequest.Builder(version, 0, 0, 0, Collections.emptyList(), Collections.emptySet());
    ...
    public void testVersionLogic()
    {
        for (short version = LEADER_AND_ISR.oldestVersion(); version <= LEADER_AND_ISR.latestVersion(); version++)
        {
            ...
            LeaderAndIsrRequest request = new LeaderAndIsrRequest.Builder(version, 1, 2, 3, partitionStates, liveNodes).build();
    ...
    public void testTopicPartitionGroupingSizeReduction()
    {
        ...
        LeaderAndIsrRequest.Builder builder = new LeaderAndIsrRequest.Builder((short) 2, 0, 0, 0, partitionStates, Collections.emptySet());
