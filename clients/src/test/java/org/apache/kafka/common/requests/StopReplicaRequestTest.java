...
public class StopReplicaRequestTest
{
    ...
    {
        StopReplicaRequest.Builder builder = new StopReplicaRequest.Builder((short) (STOP_REPLICA.latestVersion() + 1), 0, 0, 0L, false, Collections.emptyList());
    ...
    public static Map<TopicPartition, StopReplicaPartitionState> partitionStates(Iterable<StopReplicaTopicState> topicStates)
    {
