...
public class FeaturesTest
{
    ...
    {
        assertThrows(NullPointerException.class, () -> Features.finalizedFeatures(null));
    ...
    public void testFromToFinalizedFeaturesMap()
    {
        ...
        Map<String, Map<String, Short>> expected = mkMap(mkEntry("feature_1", mkMap(mkEntry("min_version_level", (short) 1), mkEntry("max_version_level", (short) 2))), mkEntry("feature_2", mkMap(mkEntry("min_version_level", (short) 3), mkEntry("max_version_level", (short) 4))));
        assertEquals(expected, features.toMap());
    ...
    public void testToStringFinalizedFeatures()
    {
        ...
        assertEquals("Features{(feature_1 -> FinalizedVersionRange[min_version_level:1, max_version_level:2]), (feature_2 -> FinalizedVersionRange[min_version_level:3, max_version_level:4])}", features.toString());
    }
    ...
    public void testFinalizedFeaturesFromMapFailureWithInvalidMissingMaxVersionLevel()
    {
        ...
        Map<String, Map<String, Short>> invalidFeatures = mkMap(mkEntry("feature_1", mkMap(mkEntry("min_version_level", (short) 1))));
        assertThrows(IllegalArgumentException.class, () -> Features.fromFinalizedFeaturesMap(invalidFeatures));
    }
