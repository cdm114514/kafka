...
public class AbstractConfigTest
{
    ...
    public void testDocumentationOf()
    {
        ...
        assertEquals(config.documentationOf(TestIndirectConfigResolution.INDIRECT_CONFIGS), TestIndirectConfigResolution.INDIRECT_CONFIGS_DOC);
    }
    ...
    private static class TestConfig extends AbstractConfig
    {
        ...
        static
        {
            CONFIG = new ConfigDef().define(METRIC_REPORTER_CLASSES_CONFIG, Type.LIST, "", Importance.LOW, METRIC_REPORTER_CLASSES_DOC);
        }
