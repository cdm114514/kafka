...
public class OAuthBearerUnsecuredValidatorCallbackHandlerTest
{
    ...
    public void validToken()
    {
        ...
        {
            String claimsJson = "{" + PRINCIPAL_CLAIM_TEXT + comma(EXPIRATION_TIME_CLAIM_TEXT) + (includeOptionalIssuedAtClaim ? comma(ISSUED_AT_CLAIM_TEXT) : "") + "}";
            Object validationResult = validationResult(UNSECURED_JWT_HEADER_JSON, claimsJson, MODULE_OPTIONS_MAP_NO_SCOPE_REQUIRED);
    ...
    public void includesRequiredScope()
    {
        ...
        Object validationResult = validationResult(UNSECURED_JWT_HEADER_JSON, claimsJson, MODULE_OPTIONS_MAP_REQUIRE_EXISTING_SCOPE);
        assertTrue(validationResult instanceof OAuthBearerValidatorCallback);
        assertTrue(((OAuthBearerValidatorCallback) validationResult).token() instanceof OAuthBearerUnsecuredJws);
    }
    ...
    private static void confirmFailsValidation(String headerJson, String claimsJson, Map<String, String> moduleOptionsMap) throws OAuthBearerConfigException, OAuthBearerIllegalTokenException, IOException, UnsupportedCallbackException
    {
