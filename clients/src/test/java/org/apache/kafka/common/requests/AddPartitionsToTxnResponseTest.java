...
public class AddPartitionsToTxnResponseTest
{
    ...
    public void testConstructorWithStruct()
    {
        ...
        topicResult.results().add(new AddPartitionsToTxnPartitionResult().setErrorCode(errorOne.code()).setPartitionIndex(partitionOne));

        topicResult.results().add(new AddPartitionsToTxnPartitionResult().setErrorCode(errorTwo.code()).setPartitionIndex(partitionTwo));

        topicCollection.add(topicResult);

        AddPartitionsToTxnResponseData data = new AddPartitionsToTxnResponseData().setResults(topicCollection).setThrottleTimeMs(throttleTimeMs);
