...
public class UpdateMetadataRequestTest
{
    ...
    {
        UpdateMetadataRequest.Builder builder = new UpdateMetadataRequest.Builder((short) (UPDATE_METADATA.latestVersion() + 1), 0, 0, 0, Collections.emptyList(), Collections.emptyList());
    ...
    public void testGetErrorResponse()
    {
        ...
        {
            UpdateMetadataRequest.Builder builder = new UpdateMetadataRequest.Builder(version, 0, 0, 0, Collections.emptyList(), Collections.emptyList());
    ...
    public void testVersionLogic()
    {
        for (short version = UPDATE_METADATA.oldestVersion(); version <= UPDATE_METADATA.latestVersion(); version++)
        {
            ...
            UpdateMetadataRequest request = new UpdateMetadataRequest.Builder(version, 1, 2, 3, partitionStates, liveBrokers).build();
    ...
    public void testTopicPartitionGroupingSizeReduction()
    {
        ...
        UpdateMetadataRequest.Builder builder = new UpdateMetadataRequest.Builder((short) 5, 0, 0, 0, partitionStates, Collections.emptyList());

        assertTrue(MessageTestUtil.messageSize(builder.build((short) 5).data(), (short) 5) < MessageTestUtil.messageSize(builder.build((short) 4).data(), (short) 4));
    }
